...
(async () => {
  console.log('🏀 Testing PLAYER ASSESSMENT (no progress bars)...');
  ...
  await page.screenshot({ path: '/tmp/assessment_no_bars.png', fullPage: true });
  console.log('✅ Screenshot saved to /tmp/assessment_no_bars.png');
