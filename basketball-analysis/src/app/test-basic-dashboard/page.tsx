...
export default function TestBasicDashboard() {
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-[#1a1a1a]/95 backdrop-blur-sm border-t border-[#3a3a3a] z-50">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-6 h-16 md:h-[72px]">
            {[
              { id: "home", icon: Home, label: "Home", href: "/test-basic-dashboard", active: true },
              { id: "lessons", icon: BookOpen, label: "Lessons", href: "/test-basic-dashboard" },
