/**
 * Attaches an uploaded ShotIQ build to its App Store version and submits it for
...
if (!app) {
  console.error(`Usage: node scripts/appstore-submit-for-review.mjs <shotiq> --build <n> [--version 1.0] [--submit]`)
  process.exit(2)
}
