...
struct AnalysisResultPresentation: Equatable {
    ...
    static let canonicalDemo = AnalysisResultPresentation(
        ...
        flaws: [
            ...
            AnalysisFlawItem(rank: 4, title: "BALL CENTERLINE CHECK", impact: "ON TRACK",
                             description: "Ball slot stays close to the body centerline through release.",
                             confidence: "88%", cta: "Review centerline",
                             phase: "RELEASE", trendEnd: "1", source: "demo"),
            AnalysisFlawItem(rank: 5, title: "LOAD + BALANCE CHECK", impact: "ON TRACK",
                             description: "Lower-body load stays stable enough to support a repeatable rise.",
                             confidence: "82%", cta: "Review load",
                             phase: "LOAD", trendEnd: "82", source: "demo"),
        ],
        ...
        if items.isEmpty,
           ...
           !result.provenance.missing.isEmpty {
            add(priority: 3,
                ...
                impact: "LOW IMPACT",
                description: "ShotIQ needs a clearer pose or saved backend result before it can rank mechanical checkpoints.",
                confidence: "0%",
                cta: "Retake analysis",
                phase: "SETUP",
                trendEnd: "0",
