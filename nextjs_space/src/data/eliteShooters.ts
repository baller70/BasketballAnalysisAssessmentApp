...
const nbaStars: EliteShooter[] = [
  ...
  createShooter({ id: idCounter++, name: "Damian Lillard", team: "Milwaukee Bucks", league: "NBA", tier: "elite", era: "2012-Present", careerPct: 37.1, achievements: "7x All-Star, Logo shots specialist", measurements: genMeasurements('elite'), overallScore: 92, formCategory: 'EXCELLENT', position: 'POINT_GUARD', height: 75, weight: 195, wingspan: 80, careerFreeThrowPct: 89.5 }),
  ...
  createShooter({ id: idCounter++, name: "Hubert Davis", team: "Multiple Teams", league: "NBA", tier: "elite", era: "1992-2004", careerPct: 44.1, achievements: "2nd highest career 3PT%", measurements: genMeasurements('elite'), overallScore: 90, formCategory: 'EXCELLENT', position: 'SHOOTING_GUARD' }),
  createShooter({ id: idCounter++, name: "Dražen Petrović", team: "New Jersey Nets", league: "NBA", tier: "elite", era: "1989-1993", careerPct: 43.7, achievements: "HOF, European legend, All-NBA", measurements: genMeasurements('elite'), overallScore: 91, formCategory: 'EXCELLENT', position: 'SHOOTING_GUARD', height: 77, weight: 195, wingspan: 79, careerFreeThrowPct: 85.0 }),
  createShooter({ id: idCounter++, name: "Joe Harris", team: "Detroit Pistons", league: "NBA", tier: "elite", era: "2014-Present", careerPct: 43.9, achievements: "3PT Contest Winner 2019", measurements: genMeasurements('elite'), overallScore: 90, formCategory: 'EXCELLENT', position: 'SHOOTING_GUARD' }),
